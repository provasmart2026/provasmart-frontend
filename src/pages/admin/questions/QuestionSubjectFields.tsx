...
export function QuestionSubjectFields({ id, subjectId, options, onSubjectChange }: QuestionSubjectFieldsProps) {
    ...
    return (
        <>
            ...
            {options.createError && (
                <p id={`${id}-subject-error`} role="alert">
                    {options.createError}
                </p>
            )}
        </>
