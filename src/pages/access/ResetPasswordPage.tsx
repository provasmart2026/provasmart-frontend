...
export function ResetPasswordPage() {
    ...
    return <AccessLayout title="Defina sua nova senha."
        ...
        <form className="access-card" onSubmit={handleSubmit}>
            ...
            <Field id="code" label="Código de redefinição" placeholder="Digite os 6 números"
                   autoComplete="one-time-code"
                   inputMode="numeric" pattern={verificationCodePattern} maxLength={6}/>
            <PasswordField id="newPassword" label="Nova senha" placeholder="Crie uma senha segura"
                           autoComplete="new-password"
                           helper="Use 8 ou mais caracteres, com maiúscula, minúscula, número e caractere especial."/>
            <PasswordField id="confirmPassword" label="Confirmar nova senha" placeholder="Digite a senha novamente"
                           autoComplete="new-password"/>
