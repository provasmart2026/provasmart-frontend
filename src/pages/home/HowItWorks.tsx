const steps = [
    {
        ...
        description:
            'Questões do formato ENEM organizadas por área e nível de dificuldade, para entender o que você precisa dar atenção.',
    },
    {
    ...
    },
    {
        ...
        description:
            'Receba prioridades personalizadas e simulados conforme sua necessidade e concentre energia no que mais gera resultado.',
    },
]
